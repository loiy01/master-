...
<body>
    <div class="register-box ">
        ...
        <form method="POST" class="text-center" action="{{ route('register') }}">
            ...
            <!-- Name -->
            <input class="" type="text" id="name" name="name" value="{{ old('name') }}" placeholder="الاسم" style="direction: rtl; text-align: right;" required autofocus>
            ...
            <!-- Address -->
            <input type="text" id="address" name="address" value="{{ old('address') }}" placeholder="العنوان" style="direction: rtl; text-align: right;" required>
