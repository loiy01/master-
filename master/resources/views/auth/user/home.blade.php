      ...
      <div class="header_section">
         <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <div class="logo" ><a href="index.html"><img src={{asset("assets/images/logo.png")}} height="50px" width="50px"></a></div>
                        ...
                        <div class="row">
                           <div class="col-sm-12">
                              <div class="banner_taital_main">
                                 <h1 class="banner_taital" style="color: darkblue;">مؤسسة الاختراق الفني</h1>
                                 <p class="banner_text" style="color: darkblue;">نقدم خدماتنا على مستوى المملكة كاملة وتتمتاز خدماتنا بوجود فريق عامل مميز واجهزة حديثة  </p>
                                 <p class="banner_text"></p>
                                 <div class="btn_main">
                                    <div class="started_text active"><a href="#">تواصل معنا</a></div>
               ...
               <div class="row" style="display: flex;justify-content: space-around;">
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main active">
                        <div class="service_img"><img src="images/core.png"></div>
                        <h4 class="development_text">فتحات كور</h4>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main">
                        <div class="service_img"><img src="images/or.png" style="height: 80px;width: 100px;"></div>
                        <h4 class="development_text">قص باطون</h4>
                        <p class="services_text">fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using L</p>
                        <div class="readmore_bt"><a href="#">Read More</a></div>
                     </div>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main">
                        <div class="service_img"><img src="images/store.png" style="height: 80px;width: 100px;"></div>
                        <h4 class="development_text">العدد</h4>
                        <p class="services_text">fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using L</p>
                        <div class="readmore_bt"><a href="#">Read More</a></div>
                     </div>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main">
                        <div class="service_img"><img src="images/store.png" style="height: 80px;width: 100px;"></div>
                        <h4 class="development_text">تاجير</h4>
                        <p class="services_text">fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using L</p>
                        <div class="readmore_bt"><a href="#">Read More</a></div>
                     </div>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main">
                        <div class="service_img"><img src="images/store.png" style="height: 80px;width: 100px;"></div>
                        <h4 class="development_text">صيانة</h4>
                        <p class="services_text">fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using L</p>
                        <div class="readmore_bt"><a href="#">Read More</a></div>
                     </div>
                  </div>
